...
public class CardTest extends TestCase {
    ...
    public void testConstructor() {
        ...
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after c = new Card('X', 1)",
        ...
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after c = new Card('S', 0)",
        ...
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after c = new Card('C', 14)",
