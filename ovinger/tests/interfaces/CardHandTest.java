...
public class CardHandTest extends TestCase {
    ...
    private void _test__cardContainer_transitions0_effects0_state_objectTests0_test() {
        ...
        assertTrue("hand ?= expected failed after hand.addCard(s1) ,hand.addCard(c2) ,hand.iterator",
                this.operator_assertEquals(this.hand, this.expected));
    ...
    private void _test__handIterator_transitions0_effects0_state_objectTests0_test() {
        ...
        assertTrue("hand ?= expected.iterator failed after hand.addCard(s1) ,hand.addCard(c2) ,hand.iterator",
