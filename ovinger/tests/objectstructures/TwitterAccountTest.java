...
public class TwitterAccountTest extends TestCase {
    ...
    @JExercise(tests = "null(String)", description = "<h3>Konstrukt\u00F8r</h3>Tests \n\t\tinitialization\n")
    public void testConstructor() {
        _test__constructor_transitions0_effects0_state();

    }

    @JExercise(tests = "null(String);void follow(objectstructures.TwitterAccount)", description = "<h3>F\u00F8lge en annen bruker</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Nils f\u00F8lger Ole: nils.follow(ole)</li>\n\t\t<li>Ole f\u00F8lger Nils: ole.follow(nils)</li>\n\t\t</ul>\n")
    ...
    @JExercise(tests = "null(String);void unfollow(objectstructures.TwitterAccount);void follow(objectstructures.TwitterAccount)", description = "<h3>Slutte \u00E5 f\u00F8lge en annen bruker</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Nils slutter \u00E5 f\u00F8lge Ole uten \u00E5 f\u00F8lge han fra f\u00F8r: nils.unfollow(ole)</li>\n\t\t<li>Nils f\u00F8lger Ole: nils.follow(ole)</li>\n\t\t<li>Nils slutter \u00E5 f\u00F8lge Ole: nils.unfollow(ole)</li>\n\t\t</ul>\n")
    ...
    @JExercise(tests = "null(String);objectstructures.Tweet getTweet(int);void tweet(String)", description = "<h3>Hente tweet fra feil indeks</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>nils.getTweet(1)</li>\n\t\t<li>nils.getTweet(-1)</li>\n\t\t<li>nils.tweet(\"Kvitre!\")</li>\n\t\t<li>nils.getTweet(2)</li>\n\t\t<li>nils.getTweet(-1)</li>\n\t\t</ul>\n")
    ...
    @JExercise(tests = "null(String);void tweet(String);void retweet(objectstructures.Tweet);objectstructures.Tweet getTweet(int)", description = "<h3>Retweete noen andres tweet</h3>Tests \n\t\tthe following sequence:\n\t\t<ul>\n\t\t<li>Nils tvitrer: nils.tweet(\"Kvitre!\")</li>\n\t\t<li>Ole retweeter Nils: ole.retweet(nils.getTweet(1))</li>\n\t\t<li>Kari retweeter Ole sin retweet: kari.retweet(ole.getTweet(1))</li>\n\t\t</ul>\n")
