...
public class NamedComparatorTest extends TestCase {
    ...
    private void _transition_exprAction__namedComparator_transitions0_actions0(final NamedComparator it,
            final Person1 ht, final Person2 jt) {
    ...
    private void _test__namedComparator_transitions0_effects0_state(final NamedComparator it, final Person1 ht,
            final Person2 jt) {
        _test__namedComparator_transitions0_effects0_state_objectTests0_test(namedComparator, ht, jt);

    }

    private void _test__namedComparator_transitions0_effects0_state_objectTests0_test(final NamedComparator it,
            final Person1 ht, final Person2 jt) {
