...
public class PersonTest extends TestCase {
    ...
    private void hasChildren(final Person person, final Collection<?> children) {
        ...
        TestCase.assertEquals(_plus_2, _size_1, _childCount);
        for (final Object child : children) {
            {
                ...
                TestCase.assertTrue(_plus_5, found);
            }
        }
    }
    ...
    public void testFarskapIllegalArgumentException() {
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after jens.father = marit",
        ...
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after anne.father = marit",
    ...
    public void testMorskapIllegalArgumentException() {
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after jens.mother = hallvard",
                    e instanceof IllegalArgumentException);
        }
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after anne.mother = hallvard",
                    e_1 instanceof IllegalArgumentException);
        }
    ...
    public void testSelvfarskapIllegalArgumentException() {
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after jens.father = jens",
                    e instanceof IllegalArgumentException);
        }
    ...
    public void testSelvmorskapIllegalArgumentException() {
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after anne.mother = anne",
                    e instanceof IllegalArgumentException);
        }
    ...
    private void _test__farskapSetFather_transitions0_effects0_state_objectTests0_test(final Person it) {
        ...
        try {
            ...
            this.hasChildren(it,
                    Collections.<Object>unmodifiableList(CollectionLiterals.<Object>newArrayList(this.jens)));
        } catch (junit.framework.AssertionFailedError error) {
    ...
    private void _test__farskapSetFather_transitions1_effects0_state_objectTests0_test(final Person it) {
        ...
        try {
            ...
            this.hasChildren(it, Collections
                    .<Object>unmodifiableList(CollectionLiterals.<Object>newArrayList(this.jens, this.anne)));
        } catch (junit.framework.AssertionFailedError error) {
    ...
    private void _test__farbytteSetFather_transitions0_effects0_state_objectTests1_test(final Person it) {
        try {
            ...
            this.hasChildren(it,
                    Collections.<Object>unmodifiableList(CollectionLiterals.<Object>newArrayList(this.anne)));
        } catch (junit.framework.AssertionFailedError error) {
