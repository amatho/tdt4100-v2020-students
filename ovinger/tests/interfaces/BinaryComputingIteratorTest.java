...
public class BinaryComputingIteratorTest extends TestCase {
    ...
    private Iterator<Double> _init_iterator1() {
        Iterator<Double> _iterator = Collections
                .<Double>unmodifiableList(
                        CollectionLiterals.<Double>newArrayList(Double.valueOf(0.5), Double.valueOf((-2.0))))
                .iterator();
        return _iterator;
    }
    ...
    private Iterator<Double> _init_iterator2() {
        Iterator<Double> _iterator = Collections.<Double>unmodifiableList(
                CollectionLiterals.<Double>newArrayList(Double.valueOf(5.0), Double.valueOf(3.0))).iterator();
        return _iterator;
    }
    ...
    private Iterator<Double> _init_iteratorShort() {
        Iterator<Double> _iterator = Collections
                .<Double>unmodifiableList(CollectionLiterals.<Double>newArrayList(Double.valueOf(5.0))).iterator();
        return _iterator;
    }
    ...
    private BinaryComputingIterator _init__computeResultsMultiplication_binaryIterator() {
        final BinaryOperator<Double> _function = (Double x, Double y) -> {
            return Double.valueOf(DoubleExtensions.operator_multiply(x, y));
        };
        BinaryComputingIterator _binaryComputingIterator = new BinaryComputingIterator(this.iterator1, this.iterator2,
                _function);
        return _binaryComputingIterator;
    }

    private void _transition_exprAction__computeResultsMultiplication_transitions0_actions0(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _test__computeResultsMultiplication_transitions0_effects0_state(
            final BinaryComputingIterator binaryIterator) {
        _test__computeResultsMultiplication_transitions0_effects0_state_objectTests0_test(binaryIterator);

    }

    private void _test__computeResultsMultiplication_transitions0_effects0_state_objectTests0_test(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _transition_exprAction__computeResultsMultiplication_transitions1_actions0(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _test__computeResultsMultiplication_transitions1_effects0_state(
            final BinaryComputingIterator binaryIterator) {
        _test__computeResultsMultiplication_transitions1_effects0_state_objectTests0_test(binaryIterator);

    }

    private void _test__computeResultsMultiplication_transitions1_effects0_state_objectTests0_test(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _transition_exprAction__computeResultsAddition_transitions0_actions0(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _test__computeResultsAddition_transitions0_effects0_state(
            final BinaryComputingIterator binaryIterator) {
        _test__computeResultsAddition_transitions0_effects0_state_objectTests0_test(binaryIterator);

    }

    private void _test__computeResultsAddition_transitions0_effects0_state_objectTests0_test(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _transition_exprAction__computeResultsAddition_transitions1_actions0(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _test__computeResultsAddition_transitions1_effects0_state(
            final BinaryComputingIterator binaryIterator) {
        _test__computeResultsAddition_transitions1_effects0_state_objectTests0_test(binaryIterator);

    }

    private void _test__computeResultsAddition_transitions1_effects0_state_objectTests0_test(
            final BinaryComputingIterator binaryIterator) {
    ...
    private BinaryComputingIterator _init__computeResultsWithShortIterator_binaryIterator() {
        ...
        BinaryComputingIterator _binaryComputingIterator = new BinaryComputingIterator(this.iterator1,
                this.iteratorShort, _function);
        return _binaryComputingIterator;
    }

    private void _transition_exprAction__computeResultsWithShortIterator_transitions0_actions0(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _test__computeResultsWithShortIterator_transitions0_effects0_state(
            final BinaryComputingIterator binaryIterator) {
        _test__computeResultsWithShortIterator_transitions0_effects0_state_objectTests0_test(binaryIterator);

    }

    private void _test__computeResultsWithShortIterator_transitions0_effects0_state_objectTests0_test(
            final BinaryComputingIterator binaryIterator) {
    ...
    private BinaryComputingIterator _init__computeResultsWithShortIteratorAndDefault_binaryIterator() {
        ...
        BinaryComputingIterator _binaryComputingIterator = new BinaryComputingIterator(this.iterator1,
                this.iteratorShort, null, Double.valueOf(2.0), _function);
        return _binaryComputingIterator;
    }

    private void _transition_exprAction__computeResultsWithShortIteratorAndDefault_transitions0_actions0(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _test__computeResultsWithShortIteratorAndDefault_transitions0_effects0_state(
            final BinaryComputingIterator binaryIterator) {
        _test__computeResultsWithShortIteratorAndDefault_transitions0_effects0_state_objectTests0_test(binaryIterator);

    }

    private void _test__computeResultsWithShortIteratorAndDefault_transitions0_effects0_state_objectTests0_test(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _transition_exprAction__computeResultsWithShortIteratorAndDefault_transitions1_actions0(
            final BinaryComputingIterator binaryIterator) {
    ...
    private void _test__computeResultsWithShortIteratorAndDefault_transitions1_effects0_state(
            final BinaryComputingIterator binaryIterator) {
        _test__computeResultsWithShortIteratorAndDefault_transitions1_effects0_state_objectTests0_test(binaryIterator);

    }

    private void _test__computeResultsWithShortIteratorAndDefault_transitions1_effects0_state_objectTests0_test(
            final BinaryComputingIterator binaryIterator) {
    ...
    private BinaryComputingIterator _init__computeResultsWithEmptyIterator_binaryIterator() {
        Iterator<Double> _iterator = Collections.<Double>unmodifiableList(CollectionLiterals.<Double>newArrayList())
                .iterator();
        Iterator<Double> _iterator_1 = Collections.<Double>unmodifiableList(CollectionLiterals.<Double>newArrayList())
                .iterator();
        final BinaryOperator<Double> _function = (Double x, Double y) -> {
            return Double.valueOf(DoubleExtensions.operator_multiply(x, y));
        };
        BinaryComputingIterator _binaryComputingIterator = new BinaryComputingIterator(_iterator, _iterator_1,
                _function);
        return _binaryComputingIterator;
    }

    private void _test__computeResultsWithEmptyIterator_transitions0_effects0_state(
            final BinaryComputingIterator binaryIterator) {
        _test__computeResultsWithEmptyIterator_transitions0_effects0_state_objectTests0_test(binaryIterator);

    }

    private void _test__computeResultsWithEmptyIterator_transitions0_effects0_state_objectTests0_test(
            final BinaryComputingIterator binaryIterator) {
    ...
    private BinaryComputingIterator _init__computeResultsWithEmptyIteratorAndDefault_binaryIterator() {
        ...
        BinaryComputingIterator _binaryComputingIterator = new BinaryComputingIterator(_iterator, _iterator_1,
                Double.valueOf(1.0), Double.valueOf(2.0), _function);
        return _binaryComputingIterator;
    }

    private void _test__computeResultsWithEmptyIteratorAndDefault_transitions0_effects0_state(
            final BinaryComputingIterator binaryIterator) {
        _test__computeResultsWithEmptyIteratorAndDefault_transitions0_effects0_state_objectTests0_test(binaryIterator);

    }

    private void _test__computeResultsWithEmptyIteratorAndDefault_transitions0_effects0_state_objectTests0_test(
            final BinaryComputingIterator binaryIterator) {
