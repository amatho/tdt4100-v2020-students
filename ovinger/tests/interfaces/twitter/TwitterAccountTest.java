...
@JExercise(description = "Tests interfaces.twitter.TwitterAccount")
...
public class TwitterAccountTest extends TestCase {
    ...
    private void _test__follow_transitions0_effect_state_objectTests0_test(final TwitterAccount it) {
        ...
        boolean _not = (!_isFollowedBy);
        assertTrue("! isFollowedBy(ole) failed after nils.follow(ole)", _not);

        int _followerCount = it.getFollowerCount();
        assertEquals("followerCount==0 failed after nils.follow(ole)", 0, _followerCount);
    ...
    private void _test__follow_transitions1_effect_state_objectTests0_test(final TwitterAccount it) {
        ...
        boolean _isFollowedBy = it.isFollowedBy(this.ole);
        assertTrue("isFollowedBy(ole) failed after ole.follow(nils)", _isFollowedBy);

        int _followerCount = it.getFollowerCount();
        assertEquals("followerCount==1 failed after ole.follow(nils)", 1, _followerCount);
    ...
    private void _test__follow_transitions1_effect_state_objectTests1_test(final TwitterAccount it) {
        ...
        assertTrue("isFollowedBy(nils) failed after ole.follow(nils)", _isFollowedBy);
    ...
    private void _test__unfollow_transitions1_effect_state_objectTests1_test(final TwitterAccount it) {
        ...
        boolean _isFollowedBy = it.isFollowedBy(this.nils);
        assertTrue("isFollowedBy(nils) failed after nils.follow(ole)", _isFollowedBy);

        int _followerCount = it.getFollowerCount();
        assertEquals("followerCount==1 failed after nils.follow(ole)", 1, _followerCount);
    ...
    private void _test__unfollow_transitions2_effect_state_objectTests1_test(final TwitterAccount it) {
        ...
        boolean _isFollowedBy = it.isFollowedBy(this.nils);
        boolean _not_1 = (!_isFollowedBy);
        assertTrue("! isFollowedBy(nils) failed after nils.unfollow(ole)", _not_1);

        int _followerCount = it.getFollowerCount();
        assertEquals("followerCount==0 failed after nils.unfollow(ole)", 0, _followerCount);
    ...
    private void _test__newTweet_transitions1_effect_state_objectTests0_test(final TwitterAccount it) {
        ...
        Tweet _tweet = it.getTweet(1);
        String _text = _tweet.getText();
        assertEquals("getTweet(1).text == \"Kvitre igjen!\" failed after nils.tweet(\"Kvitre igjen!\")",
                "Kvitre igjen!", _text);
    ...
    private void _test__retweet_transitions0_effect_state_objectTests0_test(final TwitterAccount it,
    ...
    private void _test__retweet_transitions1_effect_state_objectTests0_test(final TwitterAccount it,
            final TwitterAccount kari) {
    ...
    private void _test__retweet_transitions1_effect_state_objectTests1_test(final TwitterAccount it,
            final TwitterAccount kari) {
        ...
        assertEquals("getTweet(1).originalTweet == nils.getTweet(1) failed after ole.retweet(nils.getTweet(1))",
    ...
    private void _test__retweet_transitions2_effect_state_objectTests0_test(final TwitterAccount it,
            final TwitterAccount kari) {
    ...
    private void _test__retweet_transitions2_effect_state_objectTests1_test(final TwitterAccount it,
            final TwitterAccount kari) {
    ...
    private void _test__retweet_transitions2_effect_state_objectTests2_test(final TwitterAccount it,
            final TwitterAccount kari) {
        ...
        Tweet _tweet_2 = it.getTweet(1);
        Tweet _originalTweet = _tweet_2.getOriginalTweet();
        assertEquals("getTweet(1).originalTweet == nils.getTweet(1) failed after kari.retweet(ole.getTweet(1))",
                _tweet_1, _originalTweet);
