...
public class TweetsCountComparatorTest extends TestCase {
    ...
    private void _test__compare_transitions0_effect_state_objectTests0_test() {
        ...
        assertTrue(
                "comparator.compare(mostTweet, lessTweet1) < 0 failed after mostTweet.tweet(\"tweet\") ,mostTweet.tweet(\"tweet\") ,lessTweet1.tweet(\"tweet\") ,lessTweet2.tweet(\"tweet\")",
                _lessThan);

        int _compare_1 = this.comparator.compare(this.lessTweet1, this.mostTweet);
        boolean _greaterThan = (_compare_1 > 0);
        assertTrue(
                "comparator.compare(lessTweet1, mostTweet) > 0 failed after mostTweet.tweet(\"tweet\") ,mostTweet.tweet(\"tweet\") ,lessTweet1.tweet(\"tweet\") ,lessTweet2.tweet(\"tweet\")",
                _greaterThan);

        int _compare_2 = this.comparator.compare(this.lessTweet1, this.lessTweet2);
        assertEquals(
                "comparator.compare(lessTweet1, lessTweet2) == 0 failed after mostTweet.tweet(\"tweet\") ,mostTweet.tweet(\"tweet\") ,lessTweet1.tweet(\"tweet\") ,lessTweet2.tweet(\"tweet\")",
                0, _compare_2);
