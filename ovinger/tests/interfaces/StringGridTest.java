...
public class StringGridTest extends TestCase {
    ...
    private void _test__grid_transitions0_effects0_state_objectTests0_test(final StringGrid it) {
        ...
        assertEquals(
                "getElement(0, 0) == \"0, 0\" failed after grid.setElement(0, 0, \"0, 0\") ,grid.setElement(0, 1, \"0, 1\") ,grid.setElement(0, 2, \"0, 2\") ,grid.setElement(1, 0, \"1, 0\") ,grid.setElement(1, 1, \"1, 1\") ,grid.setElement(1, 2, \"1, 2\")",
                "0, 0", _element);

        String _element_1 = it.getElement(0, 1);
        assertEquals(
                "getElement(0, 1) == \"0, 1\" failed after grid.setElement(0, 0, \"0, 0\") ,grid.setElement(0, 1, \"0, 1\") ,grid.setElement(0, 2, \"0, 2\") ,grid.setElement(1, 0, \"1, 0\") ,grid.setElement(1, 1, \"1, 1\") ,grid.setElement(1, 2, \"1, 2\")",
                "0, 1", _element_1);

        String _element_2 = it.getElement(0, 2);
        assertEquals(
                "getElement(0, 2) == \"0, 2\" failed after grid.setElement(0, 0, \"0, 0\") ,grid.setElement(0, 1, \"0, 1\") ,grid.setElement(0, 2, \"0, 2\") ,grid.setElement(1, 0, \"1, 0\") ,grid.setElement(1, 1, \"1, 1\") ,grid.setElement(1, 2, \"1, 2\")",
                "0, 2", _element_2);

        String _element_3 = it.getElement(1, 0);
        assertEquals(
                "getElement(1, 0) == \"1, 0\" failed after grid.setElement(0, 0, \"0, 0\") ,grid.setElement(0, 1, \"0, 1\") ,grid.setElement(0, 2, \"0, 2\") ,grid.setElement(1, 0, \"1, 0\") ,grid.setElement(1, 1, \"1, 1\") ,grid.setElement(1, 2, \"1, 2\")",
                "1, 0", _element_3);

        String _element_4 = it.getElement(1, 1);
        assertEquals(
                "getElement(1, 1) == \"1, 1\" failed after grid.setElement(0, 0, \"0, 0\") ,grid.setElement(0, 1, \"0, 1\") ,grid.setElement(0, 2, \"0, 2\") ,grid.setElement(1, 0, \"1, 0\") ,grid.setElement(1, 1, \"1, 1\") ,grid.setElement(1, 2, \"1, 2\")",
                "1, 1", _element_4);

        String _element_5 = it.getElement(1, 2);
        assertEquals(
                "getElement(1, 2) == \"1, 2\" failed after grid.setElement(0, 0, \"0, 0\") ,grid.setElement(0, 1, \"0, 1\") ,grid.setElement(0, 2, \"0, 2\") ,grid.setElement(1, 0, \"1, 0\") ,grid.setElement(1, 1, \"1, 1\") ,grid.setElement(1, 2, \"1, 2\")",
                "1, 2", _element_5);
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions0_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions0_actions1(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions0_actions2(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions0_actions3(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions0_actions4(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions0_actions5(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _test__gridIteratorRowMajor_transitions0_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorRowMajor_transitions0_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorRowMajor_transitions0_effects0_state_objectTests0_test(final StringGridIterator it,
            final StringGridIterator gridIterator) {

        boolean _hasNext = it.hasNext();
        assertEquals(
                "hasNext == true failed after grid.setElement(0, 0, \"0, 0\") ,grid.setElement(0, 1, \"0, 1\") ,grid.setElement(0, 2, \"0, 2\") ,grid.setElement(1, 0, \"1, 0\") ,grid.setElement(1, 1, \"1, 1\") ,grid.setElement(1, 2, \"1, 2\")",
                true, _hasNext);

    }

    private void _transition_exprAction__gridIteratorRowMajor_transitions1_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorRowMajor_transitions1_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorRowMajor_transitions1_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorRowMajor_transitions1_effects0_state_objectTests0_test(final StringGridIterator it,
            final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions2_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorRowMajor_transitions2_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorRowMajor_transitions2_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorRowMajor_transitions2_effects0_state_objectTests0_test(final StringGridIterator it,
            final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions3_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorRowMajor_transitions3_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorRowMajor_transitions3_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorRowMajor_transitions3_effects0_state_objectTests0_test(final StringGridIterator it,
            final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions4_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorRowMajor_transitions4_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorRowMajor_transitions4_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorRowMajor_transitions4_effects0_state_objectTests0_test(final StringGridIterator it,
            final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions5_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorRowMajor_transitions5_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorRowMajor_transitions5_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorRowMajor_transitions5_effects0_state_objectTests0_test(final StringGridIterator it,
            final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorRowMajor_transitions6_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorRowMajor_transitions6_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorRowMajor_transitions6_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorRowMajor_transitions6_effects0_state_objectTests0_test(final StringGridIterator it,
            final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions0_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions0_actions1(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions0_actions2(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions0_actions3(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions0_actions4(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions0_actions5(final StringGrid it,
            final StringGridIterator gridIterator) {
        try {
    ...
    private void _test__gridIteratorColumnMajor_transitions0_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorColumnMajor_transitions0_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorColumnMajor_transitions0_effects0_state_objectTests0_test(
            final StringGridIterator it, final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions1_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorColumnMajor_transitions1_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorColumnMajor_transitions1_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorColumnMajor_transitions1_effects0_state_objectTests0_test(
            final StringGridIterator it, final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions2_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorColumnMajor_transitions2_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorColumnMajor_transitions2_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorColumnMajor_transitions2_effects0_state_objectTests0_test(
            final StringGridIterator it, final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions3_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorColumnMajor_transitions3_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorColumnMajor_transitions3_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorColumnMajor_transitions3_effects0_state_objectTests0_test(
            final StringGridIterator it, final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions4_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorColumnMajor_transitions4_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorColumnMajor_transitions4_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorColumnMajor_transitions4_effects0_state_objectTests0_test(
            final StringGridIterator it, final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions5_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorColumnMajor_transitions5_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorColumnMajor_transitions5_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorColumnMajor_transitions5_effects0_state_objectTests0_test(
            final StringGridIterator it, final StringGridIterator gridIterator) {
    ...
    private void _transition_exprAction__gridIteratorColumnMajor_transitions6_actions0(final StringGrid it,
            final StringGridIterator gridIterator) {
    ...
    private void _test__gridIteratorColumnMajor_transitions6_effects0_state(final StringGrid it,
            final StringGridIterator gridIterator) {
        _test__gridIteratorColumnMajor_transitions6_effects0_state_objectTests0_test(gridIterator, gridIterator);

    }

    private void _test__gridIteratorColumnMajor_transitions6_effects0_state_objectTests0_test(
            final StringGridIterator it, final StringGridIterator gridIterator) {
