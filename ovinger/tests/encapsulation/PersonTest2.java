...
@JExercise(description = "A Person must contain a name, an email, a birthday, gender and social security number. These attributes should be properly encapsulated and have getters and setters that ensure valid attributes")
public class PersonTest2 extends PersonTest {
    ...
    @JExercise(tests = "void setSSN(String)", description = "The setSSN(String) should set social security number to input argument, given that the SSN is valid")
