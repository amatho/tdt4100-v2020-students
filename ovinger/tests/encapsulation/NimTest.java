...
public class NimTest extends TestCase {
    ...
    public void testRemovePieces() {
        ...
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after removePieces(-1, 0)",
        ...
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after removePieces(0, 0)",
        ...
        try {
            ...
            assertTrue("IllegalArgumentException should be thrown after removePieces(6, 0)",
    ...
    public void testGameOver() {
        ...
        try {
            ...
            assertTrue("IllegalStateException should be thrown after removePieces(5, 0)",
    ...
    private void _test__removePieces_transitions0_effects0_state_objectTests0_test(final Nim it) {
        ...
        int _pile = it.getPile(0);
        assertEquals("getPile(0) == 2 failed after removePieces(3, 0) ,removePieces(2, 1) ,removePieces(1, 2)", 2,
                _pile);

        int _pile_1 = it.getPile(1);
        assertEquals("getPile(1) == 3 failed after removePieces(3, 0) ,removePieces(2, 1) ,removePieces(1, 2)", 3,
                _pile_1);

        int _pile_2 = it.getPile(2);
        assertEquals("getPile(2) == 4 failed after removePieces(3, 0) ,removePieces(2, 1) ,removePieces(1, 2)", 4,
                _pile_2);
