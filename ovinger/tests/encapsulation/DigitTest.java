...
public class DigitTest extends TestCase {
    ...
    @JExercise(tests = "Digit(int);int getValue();int getBase()", description = "The Digit(int) constructor should initialize value at zero. The getValue() method returns the value. The getBase() method returns the base.")
