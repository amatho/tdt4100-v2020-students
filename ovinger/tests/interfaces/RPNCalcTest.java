...
public class RPNCalcTest extends TestCase {
    ...
    public void testPerformOperation() {
        ...
        assertEquals("Previous values are not popped from the stack before performing an operation", Double.NaN,
                calc.pop());
        calc.push(4);
        calc.push(3);
    ...
    public void testAddOperator() {
        ...
        assertFalse("Adding duplicate operator with different definition returned true",
