...
public class CardHandTest extends TestCase {
    ...
    private void _test__deal_transitions0_effects0_state_objectTests0_test(final CardHand it, final CardDeck deck) {
        ...
        assertTrue("it ?= #[\"C2\", \"C1\", \"D2\"] failed after deck.deal(cardHand, 3)", this.operator_assertEquals(it,
                Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList("C2", "C1", "D2"))));
    ...
    private void _test__dealPlay_transitions1_effects0_state_objectTests0_test(final CardHand it, final CardDeck deck) {
        ...
        assertTrue("it ?= #[\"C2\", \"D2\"] failed after play(1)", this.operator_assertEquals(it,
                Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList("C2", "D2"))));
    ...
    private void _test__dealPlay_transitions2_effects0_state_objectTests0_test(final CardHand it, final CardDeck deck) {
        ...
        assertTrue("it ?= #[\"D2\"] failed after play(0)", this.operator_assertEquals(it,
                Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList("D2"))));
