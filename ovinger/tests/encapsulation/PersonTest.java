...
@JExercise(description = "A Person must contain a name, an email, a birthday and gender. These attributes should be properly encapsulated and have getters and setters that ensure valid attributes")
public class PersonTest extends TestCase {
    ...
    @JExercise(tests = "setName(String)", description = "The setName(String) sets the name to the argument string, given that the name is within a valid format")
    ...
    @JExercise(tests = "void setBirthday(Date)", description = "The setBirthday(Date) should set birthday to input argument, given that the birthday is on a valid format.")
    ...
    @JExercise(tests = "void setEmail(String)", description = "The setEmail(String) should set email to input argument, given that the email is on a valid format")
    ...
    @JExercise(tests = "void setEmail(String)", description = "The setEmail(String) should set email to input argument, given that the email is on a vaild format. Tests for valid domains with valid cTLDs")
    ...
    @JExercise(tests = "void setGender(char)", description = "The setGender(char) should set gender to input argument, given that the gender is on a valid format")
